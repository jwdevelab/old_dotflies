...
/* appearance */
static const unsigned int borderpx  = 2;        /* border pixel of windows */ static const unsigned int snap      = 32;       /* snap pixel */ static const int showbar            = 1;        /* 0 means no bar */
...
static const char col_gray4[]       = "#D0BFA1";
...
static const char *brup[] = { "/usr/local/bin/brup.sh", NULL };
static const char *brdown[] = { "/usr/local/bin/brdwon.sh", NULL };

#include <X11/XF86keysym.h>
#include "shiftview.c"
static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_a,      spawn,          {.v = thunar } },
